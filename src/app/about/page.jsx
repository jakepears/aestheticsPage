  ...
  return (
    <div className="mt-24 rounded-4xl bg-neutral-950 py-24 sm:mt-32 lg:mt-40 lg:py-32">
      <SectionIntro
        ...
        invert
      >
        <p>A group of like-minded people who share the same values.</p>
      </SectionIntro>
      <Container className="mt-16">
        <GridList>
          ...
          <GridListItem title="Compassion" invert>
            Understanding the importance of empathy, we create a supportive
            environment where team members feel valued and respected. While
            respecting boundaries, we cultivate a culture of compassion,
...
export const metadata = {
  title: 'About Us',
  description:
    'Strength lies in our collaborative approach, which puts our clients at the center of everything we do.',
}
      ...
      <PageIntro eyebrow="About us" title="Strength is collaboration">
        ...
        <div className="mt-10 max-w-2xl space-y-6 text-base">
          ...
          <p>
            ...
            clients not just as customers, but as valued members of the
            community. I strive to create a welcoming environment where everyone
            feels appreciated and supported.
          </p>
        </div>
      </PageIntro>
      <Container className="mt-16">
